...
model18 = lm(smoothed_grass ~ smoothed_pdo + summer_ppt_mm + nino34, data=model_data)
model19 = lm(smoothed_grass ~ smoothed_pdo + summer_ppt_mm + yearly_ppt_mm, data=model_data)
model20 = lm(smoothed_grass ~ smoothed_pdo + summer_ppt_mm + spei, data=model_data)
