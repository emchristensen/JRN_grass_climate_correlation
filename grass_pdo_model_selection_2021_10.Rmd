...
model4s = lm(smoothed_grass ~ smoothed_nino, data=model_data)
model5 = lm(smoothed_grass ~ yearly_ppt_mm, data=model_data)
model5s = lm(smoothed_grass ~ smoothed_yearlyppt, data=model_data)
model6 = lm(smoothed_grass ~ winter_ppt_mm, data=model_data)
model6s = lm(smoothed_grass ~ smoothed_winterppt, data=model_data)
model7 = lm(smoothed_grass ~ summer_ppt_mm, data=model_data)
model7s = lm(smoothed_grass ~ smoothed_summerppt, data=model_data)
model8 = lm(smoothed_grass ~ pdsi, data=model_data)
model8s = lm(smoothed_grass ~ smoothed_pdsi, data=model_data)
model9 = lm(smoothed_grass ~ spei, data=model_data)
model9s = lm(smoothed_grass ~ smoothed_spei, data=model_data)
model10 = lm(smoothed_grass ~ mean_temp, data=model_data)
model10s = lm(smoothed_grass ~ smoothed_temp, data=model_data)
...
modellist = list(model1, model2, model3, model4, model5, model6, model7, model8, model9, model10, model11, model12, model13, model14,
                 ...
                 model4s, model5s, model6s, model7s, model8s, model9s, model10s)
aictable = c()
