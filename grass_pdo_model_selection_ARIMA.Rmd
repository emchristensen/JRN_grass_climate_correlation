...
arima.NoPred <- auto.arima(dta[,"grass"], stepwise=FALSE, approximation=FALSE) # ARIMA with grass only (no covariates)
arima.mean_10y <- auto.arima(dta[,"grass"], xreg = dta[, "pdo_mean_10y"], stepwise=FALSE, approximation=FALSE)
#arima.pc1 <- auto.arima(dta[,"grass"], xreg = dta[, "PC1"], stepwise=FALSE, approximation=FALSE)
#arima.pc2 <- auto.arima(dta[,"grass"], xreg = dta[, "PC2"], stepwise=FALSE, approximation=FALSE)
#arima.pc3 <- auto.arima(dta[,"grass"], xreg = dta[, "PC3"], stepwise=FALSE, approximation=FALSE)
#arima.pc12 <- auto.arima(dta[,"grass"], xreg = dta[, c("PC1", "PC2")], stepwise=FALSE, approximation=FALSE)
#arima.pc13 <- auto.arima(dta[,"grass"], xreg = dta[, c("PC1", "PC3")], stepwise=FALSE, approximation=FALSE)
#arima.pc23 <- auto.arima(dta[,"grass"], xreg = dta[, c("PC2", "PC3")], stepwise=FALSE, approximation=FALSE)
arima.pc123 <- auto.arima(dta[,"grass"], xreg = dta[, c("PC1", "PC2", "PC3")], stepwise=FALSE, approximation=FALSE)
arima.mean_10y.pc1 <- auto.arima(dta[,"grass"], xreg = dta[, c("pdo_mean_10y", "PC1")], stepwise=FALSE, approximation=FALSE)
arima.mean_10y.pc2 <- auto.arima(dta[,"grass"], xreg = dta[, c("pdo_mean_10y", "PC2")], stepwise=FALSE, approximation=FALSE)
arima.mean_10y.pc3 <- auto.arima(dta[,"grass"], xreg = dta[, c("pdo_mean_10y", "PC3")], stepwise=FALSE, approximation=FALSE)
arima.mean_10y.pc12 <- auto.arima(dta[,"grass"], xreg = dta[, c("pdo_mean_10y", "PC1", "PC2")], stepwise=FALSE, approximation=FALSE)
arima.mean_10y.pc13 <- auto.arima(dta[,"grass"], xreg = dta[, c("pdo_mean_10y", "PC1", "PC3")], stepwise=FALSE, approximation=FALSE)
arima.mean_10y.pc23 <- auto.arima(dta[,"grass"], xreg = dta[, c("pdo_mean_10y", "PC2", "PC3")], stepwise=FALSE, approximation=FALSE)
arima.mean_10y.pc123 <- auto.arima(dta[,"grass"], xreg = dta[, c("pdo_mean_10y", "PC1", "PC2", "PC3")], stepwise=FALSE, approximation=FALSE)
arima.enso_phase <- auto.arima(dta[,"grass"], xreg = dta[, "enso_phase"], stepwise=FALSE, approximation=FALSE)
arima.mean_10y.enso <- auto.arima(dta[,"grass"], xreg = dta[, c("pdo_mean_10y","enso_phase")], stepwise=FALSE, approximation=FALSE)
arima.mean_10y.enso.pc123 <- auto.arima(dta[,"grass"], xreg = dta[, c("pdo_mean_10y","enso_phase","PC1","PC2","PC3")], stepwise=FALSE, approximation=FALSE)
...
aicc.allmodels <- data.frame(
  ...
  AICc = c(AICc(null.lm),
           ...
           #arima.pc23$aicc,
           arima.pc123$aicc,
           #arima.mean_10y.pc1$aicc,
           #arima.mean_10y.pc2$aicc,
           #arima.mean_10y.pc3$aicc,
           #arima.mean_10y.pc12$aicc,
           #arima.mean_10y.pc13$aicc,
           #arima.mean_10y.pc23$aicc,
    ...
    rsquared = c(summary(null.lm)$adj.r.squared,
               arima_rsquare(arima.NoPred),
               arima_rsquare(arima.mean_10y),
               #arima_rsquare(arima.pc1),
               #arima_rsquare(arima.pc2),
               #arima_rsquare(arima.pc3),
               #arima_rsquare(arima.pc12),
               #arima_rsquare(arima.pc13),
               #arima_rsquare(arima.pc23),
               arima_rsquare(arima.pc123),
               #arima_rsquare(arima.mean_10y.pc1),
               #arima_rsquare(arima.mean_10y.pc2),
               #arima_rsquare(arima.mean_10y.pc3),
               #arima_rsquare(arima.mean_10y.pc12),
               #arima_rsquare(arima.mean_10y.pc13),
               #arima_rsquare(arima.mean_10y.pc23),
