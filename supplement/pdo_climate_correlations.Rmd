...
plotdata = dplyr::filter(climate, !is.na(pdo_phase))
...
allplots = ggpubr::ggarrange(yearly, summer, winter, speiplot, pdsiplot, meantemp, 
                             nrow=2, ncol=3, labels='AUTO')
allplots
ggsave('../Figures/pdo_climate_variable_boxplots.png', plot=allplots, width=7, height=4)
